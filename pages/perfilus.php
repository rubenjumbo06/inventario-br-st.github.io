    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in">
        <div class="flex flex-col md:flex-row">
            <div class="md:w-1/3 text-center mb-8 md:mb-0">
                ...
                <h1 class="text-2xl font-bold text-[#22694c] dark:text-[#22694c] mb-2">Ruben Jumbo</h1>
                <p class="text-gray-600 dark:text-gray-300">Usuario</p>
            ...
            <div class="md:w-2/3 md:pl-8">
                ...
                <p class="text-gray-700 dark:text-gray-300 mb-6 text-justify">
                    Como Usuario del sistema de gestión de inventarios, tienes acceso a 2 funciones clave del sistema, 
